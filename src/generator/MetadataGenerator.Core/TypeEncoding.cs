...
namespace MetadataGenerator.Core
{
    public abstract class TypeEncoding
    {
        ...
        public static TypeEncoding Interface(string name, string module)
        {
        ...
        public static TypeEncoding Id(IEnumerable<Tuple<string, string>> protocols)
        {
        ...
        public static TypeEncoding Struct(string name, string module)
        {
        ...
        public static TypeEncoding Union(string name, string module)
        {
        ...
        public static TypeEncoding InterfaceDeclaration(string name, string module)
        {
        ...
        {
            return this == TypeEncoding.Unknown;
        }
        ...
        private class InterfaceEncoding : TypeEncoding
        {
            ...
            {
                return visitor.TransformInterface(this.Name, this.Module);
            }
        }
        ...
        private class StructEncoding : TypeEncoding
        {
            ...
            public override T Transform<T>(TypeEncodingTransfomation<T> visitor)
            {
                return visitor.TransformStruct(this.Name, this.Module);
            }
        }
        ...
        private class UnionEncoding : TypeEncoding
        {
            ...
            public override T Transform<T>(TypeEncodingTransfomation<T> visitor)
            {
                return visitor.TransformUnion(this.Name, this.Module);
            }
        }
        ...
        {
            private readonly Tuple<string, string>[] protocols;

            public IdEncoding()
                : this(new Tuple<string, string>[0])
            {
            }

            // Item1 -> full module name, Item2 -> protocol name
            public IdEncoding(IEnumerable<Tuple<string, string>> protocols)
            {
        ...
        private class InterfaceDeclarationEncoding : TypeEncoding
        {
            ...
            public override T Transform<T>(TypeEncodingTransfomation<T> visitor)
            {
                return visitor.TransformInterfaceDeclaration(this.Name, this.Module);
            }
        }
