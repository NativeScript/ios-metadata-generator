namespace TypeScript.Factory
{
    ...
    public partial class TypeScriptFactory
    {
        private class MetaToTypeScriptTypeTransform : TypeEncodingTransfomation<TS.IType>
        {
            ...
            protected override TS.IType TransformId(params Tuple<string, string>[] protocols)
            {
            ...
            protected override TS.IType TransformInterface(string name, string moduleName)
            {
                if (name == "NSString")
                {
                    return TS.PrimitiveTypes.String;
            ...
            protected override TS.IType TransformStruct(string name, string moduleName)
            {
                return this.builder.GetTypeForStructMetaName(name);
            }

            protected override TS.IType TransformUnion(string name, string moduleName)
            {
                return this.builder.GetTypeForUnionMetaName(name);
            }

            protected override TS.IType TransformInterfaceDeclaration(string name, string moduleName)
            {
                return TS.PrimitiveTypes.Any;
            }
