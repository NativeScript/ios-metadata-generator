...
namespace Libclang.Core.Ast
{
    ...
    {
        private Lazy<IDictionary<string, object>> metadataPropertyBag =
        ...
        internal IDictionary<string, object> MetadataPropertyBag
        {
            get
            {
                return metadataPropertyBag.Value;
            }
        }
        ...
        public virtual ModuleDeclaration Module { get; set; }
        ...
        public abstract void Accept(Meta.Visitors.IDeclarationVisitor visitor);
    }
}
