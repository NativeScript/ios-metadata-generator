...
namespace Libclang.Core
{
    public class TypeEncodingTransfomation<TReturn>
    {
        ...
        protected internal virtual TReturn TransformId(params string[] protocols)
        {
            return this.Default();
        }
        ...
        protected internal virtual TReturn TransformInterface(string name)
        {
            return this.Default();
        }
        ...
        protected internal virtual TReturn TransformStruct(string name)
        {
            return this.Default();
        }

        protected internal virtual TReturn TransformUnion(string name)
        {
            return this.Default();
        }

        protected internal virtual TReturn TransformInterfaceDeclaration(string name)
        {
            return this.Default();
        }
